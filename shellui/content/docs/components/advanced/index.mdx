...
<Cards>
  <Card title="Charts" href="/docs/components/advanced/charts" description="Data visualization with ApexCharts - Bar, Line, Area, Pie, and Multi-Series charts (5 subpages)" />
