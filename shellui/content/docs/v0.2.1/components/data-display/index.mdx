...
<Cards>
  <Card title="Table" href="/docs/v0.2.1/components/data-display/table" description="Structured data presentation in rows and columns" />
  <Card title="DataTable" href="/docs/v0.2.1/components/data-display/data-table" description="Advanced table with sorting and filtering" />
  <Card title="Badge" href="/docs/v0.2.1/components/data-display/badge" description="Status indicators and labels" />
  <Card title="Avatar" href="/docs/v0.2.1/components/data-display/avatar" description="User profile images and initials" />
  <Card title="Alert" href="/docs/v0.2.1/components/data-display/alert" description="Status messages and notifications" />
  <Card title="Toast" href="/docs/v0.2.1/components/data-display/toast" description="Non-intrusive notifications" />
  <Card title="Skeleton" href="/docs/v0.2.1/components/data-display/skeleton" description="Loading state placeholders" />
  <Card title="Progress" href="/docs/v0.2.1/components/data-display/progress" description="Progress indicators and bars" />
  <Card title="Loading" href="/docs/v0.2.1/components/data-display/loading" description="Loading spinners and indicators" />
</Cards>
