...
<Cards>
  <Card title="Charts" href="/docs/v0.2.1/components/advanced/charts" description="Data visualization with ApexCharts - Bar, Line, Area, Pie, and Multi-Series charts (5 subpages)" />
  <Card title="Calendar" href="/docs/v0.2.1/components/advanced/calendar" description="Date selection calendar" />
  <Card title="Date Picker" href="/docs/v0.2.1/components/advanced/date-picker" description="Date input with calendar popup" />
  <Card title="Date Range Picker" href="/docs/v0.2.1/components/advanced/date-range-picker" description="Date range selection" />
  <Card title="Time Picker" href="/docs/v0.2.1/components/advanced/time-picker" description="Time selection component" />
  <Card title="Combobox" href="/docs/v0.2.1/components/advanced/combobox" description="Autocomplete input with dropdown" />
  <Card title="Alert Dialog" href="/docs/v0.2.1/components/advanced/alert-dialog" description="Confirmation dialog component" />
  <Card title="Carousel" href="/docs/v0.2.1/components/advanced/carousel" description="Image/content carousel with navigation" />
  <Card title="DataTable" href="/docs/v0.2.1/components/advanced/data-table" description="Advanced table with sorting and filtering" />
</Cards>
