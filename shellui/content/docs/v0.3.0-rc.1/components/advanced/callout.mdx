---
title: Callout
description: Admonition boxes for info, warnings, tips, and danger notices — new in v0.3.0-rc.1.
---

`Callout` is **new in v0.3.0-rc.1**. It renders styled admonition boxes using the `CalloutVariant` enum — useful for documentation, inline warnings, and instructional content.
...
`callout-variants` is auto-installed as a dependency.
...
<Callout Variant="CalloutVariant.Warning" Title="Before you upgrade">
    <p>Review the following before upgrading to v0.3.0-rc.1:</p>
