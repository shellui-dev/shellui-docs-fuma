---
title: LinkCard
description: Card-style navigation link — new in v0.3.0-rc.1.
---

`LinkCard` is **new in v0.3.0-rc.1**. It renders a styled `<a>` tag that looks like a Card — perfect for "see also" grids, related docs sections, or feature link lists.
...
```razor
<LinkCard Href="/docs/v0.3.0-rc.1/installation" Title="Installation">
...
<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
    <LinkCard Href="/docs/v0.3.0-rc.1/quickstart" Title="Quick Start">
        Build your first ShellUI component in under 5 minutes.
    </LinkCard>
    <LinkCard Href="/docs/v0.3.0-rc.1/components" Title="Components">
        Browse all 80+ available components.
    </LinkCard>
    <LinkCard Href="/docs/v0.3.0-rc.1/theming" Title="Theming">
        Customise colors, radius, and shadows with CSS variables.
    </LinkCard>
    <LinkCard Href="/docs/v0.3.0-rc.1/contributing" Title="Contributing">
