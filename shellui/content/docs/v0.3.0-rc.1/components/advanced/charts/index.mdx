...
<Cards>
  <Card title="Bar Chart" href="/docs/v0.3.0-rc.1/components/advanced/charts/bar-chart" description="Vertical bar charts for comparing values across categories" />
  <Card title="Line Chart" href="/docs/v0.3.0-rc.1/components/advanced/charts/line-chart" description="Smooth line charts for showing trends over time" />
  <Card title="Area Chart" href="/docs/v0.3.0-rc.1/components/advanced/charts/area-chart" description="Filled area charts for showing volume and trends" />
  <Card title="Pie Chart" href="/docs/v0.3.0-rc.1/components/advanced/charts/pie-chart" description="Pie charts with custom tooltips for proportions" />
  <Card title="Multi-Series Chart" href="/docs/v0.3.0-rc.1/components/advanced/charts/multi-series-chart" description="Multiple data series with mixed chart types" />
</Cards>
