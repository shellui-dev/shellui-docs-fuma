---
title: Sonner
description: Modern toast notifications — new in v0.3.0-rc.1.
---

`Sonner` is **new in v0.3.0-rc.1**. It provides shadcn-style stacked toast notifications via a `SonnerService` injectable service.
