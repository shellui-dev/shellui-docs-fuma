---
title: CopyButton
description: One-click clipboard copy button — new in v0.3.0-rc.1.
---

`CopyButton` is **new in v0.3.0-rc.1**. It copies text to the clipboard via the browser's Clipboard API and gives visual feedback with a checkmark icon for ~2 seconds after copying.
