---
title: PrevNextNav
description: Previous/Next page navigation links — new in v0.3.0-rc.1.
---

`PrevNextNav` is **new in v0.3.0-rc.1**. It renders a pair of bordered navigation links for moving between doc pages. Perfect for adding at the bottom of any page.
...
<PrevNextNav
    ...
    PrevHref="/docs/v0.3.0-rc.1/installation"
    NextLabel="Components"
    NextHref="/docs/v0.3.0-rc.1/components" />
```
...
<PrevNextNav
    ...
    NextHref="/docs/v0.3.0-rc.1/quickstart" />
```
...
<PrevNextNav
    ...
    PrevHref="/docs/v0.3.0-rc.1/quickstart" />
```
