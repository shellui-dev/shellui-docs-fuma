...
v0.3.0-rc.1 adds `NavList`, `NavItem`, `NavTrigger`, and `NavContent` subcomponents for a fully compositional navigation pattern.
...
<NavigationMenu>
    <NavList>
        ...
        <NavItem>
            ...
            <NavContent>
                <div class="grid gap-2 p-2 w-48">
                    <a href="/docs/v0.3.0-rc.1/quickstart" class="block rounded-md p-2 hover:bg-accent text-sm">Quick Start</a>
                    <a href="/docs/v0.3.0-rc.1/installation" class="block rounded-md p-2 hover:bg-accent text-sm">Installation</a>
                </div>
            </NavContent>
        </NavItem>
    </NavList>
                ...
                <NavItem>
                    ...
                    <NavContent>
                        <div class="grid grid-cols-2 gap-1 p-2 w-80">
                            <a href="/docs/v0.3.0-rc.1/components/form" class="rounded-md p-2 hover:bg-accent text-sm">Form</a>
                            <a href="/docs/v0.3.0-rc.1/components/layout" class="rounded-md p-2 hover:bg-accent text-sm">Layout</a>
                            <a href="/docs/v0.3.0-rc.1/components/navigation" class="rounded-md p-2 hover:bg-accent text-sm">Navigation</a>
                            <a href="/docs/v0.3.0-rc.1/components/advanced" class="rounded-md p-2 hover:bg-accent text-sm">Advanced</a>
                        </div>
                    </NavContent>
                </NavItem>
            </NavList>
