...
| Tailwind CSS | Yes (v4.1.18) | No (Bootstrap) |
| No Node.js Required | Yes (Standalone CLI) | N/A |
| Hybrid Workflow | Yes | No |
| Type-Safe Variants | Yes (CVA) | No |
| Charts | Yes (ApexCharts) | Yes (MudChart) |
| Free & Open Source | Yes (MIT) | Yes (MIT) |
| Components | 80 | 70+ |
| Customization | Full Control | Limited |
| Current Status | v0.2.0 Production Ready | Mature |
...
| Installation Method | CLI + NuGet | NuGet |
| Component Ownership | Yes | No |
| Tailwind CSS | Yes (v4.1.18) | No (Custom) |
| Visual Designer | No | Yes |
| Code Generation | No | Yes |
| Charts | Yes (ApexCharts) | Yes |
| Type-Safe Variants | Yes (CVA) | No |
| Free & Open Source | Yes (MIT) | Partial |
| Components | 80 | 50+ |
| Customization | Full Control | Limited |
| Current Status | v0.2.0 Production Ready | Commercial |
...
| Installation Method | CLI + NuGet | NuGet |
| Component Ownership | Yes | No |
| Tailwind CSS | Yes (v4.1.18) | No (Bootstrap/Material/Bulma) |
| CSS Framework Support | Tailwind Only | Multiple |
| Charts | Yes (ApexCharts) | Yes (ChartJS) |
| Type-Safe Variants | Yes (CVA) | No |
| Free & Open Source | Yes (MIT) | Yes (MIT) |
| Components | 80 | 80+ |
| Customization | Full Control | Limited |
...
- Want data visualization with ApexCharts integration
...
Ready to try ShellUI? Get started with our [Quickstart Guide](/docs/v0.3.0-alpha.2/quickstart) or [Installation Guide](/docs/v0.3.0-alpha.2/installation).
