...
<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
    <LinkCard Href="/docs/quickstart" Title="Quick Start">
        Build your first ShellUI component in under 5 minutes.
    </LinkCard>
    <LinkCard Href="/docs/components" Title="Components">
        Browse all 80+ available components.
    </LinkCard>
    <LinkCard Href="/docs/theming" Title="Theming">
        Customise colors, radius, and shadows with CSS variables.
    </LinkCard>
    <LinkCard Href="/docs/contributing" Title="Contributing">
